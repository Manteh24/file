...
const faqs = [
  {
    q: "آیا واقعاً نیازی به کارت بانکی برای شروع آزمایشی ندارم؟",
    a: "بله، کاملاً درست است. برای فعال‌سازی دوره آزمایشی ۳۰ روزه پلن‌های حرفه‌ای و تیمی هیچ اطلاعات پرداختی نیاز نیست. پس از پایان دوره آزمایشی، می‌توانید به پلن رایگان برگردید یا اشتراک تهیه کنید.",
  },
  {
  ...
  },
  {
    ...
    a: "بله. در پلن رایگان تا ۱ کاربر، در پلن حرفه‌ای تا ۷ مشاور، و در پلن تیمی تعداد نامحدود مشاور می‌توانید اضافه کنید. هر مشاور با نام‌کاربری خودش وارد می‌شود و فایل‌های ثبت‌شده توسط او قابل ردیابی است.",
  },
  {

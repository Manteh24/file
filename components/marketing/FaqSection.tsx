...
const faqs = [
  {
    ...
    a: "خیر. پلن رایگان کاملاً رایگان است و هیچ اطلاعات پرداختی نیاز ندارد. پلن‌های حرفه‌ای و تیم با ۳۰ روز آزمایشی رایگان همراه هستند.",
  },
  {
  ...
  },
  {
    ...
    a: "بله. در پلن رایگان تا ۱ کاربر، در پلن حرفه‌ای تا ۱۰ مشاور، و در پلن تیم تعداد نامحدود مشاور می‌توانید اضافه کنید. هر مشاور با نام‌کاربری خودش وارد می‌شود و فایل‌های ثبت‌شده توسط او قابل ردیابی است.",
  },
  {

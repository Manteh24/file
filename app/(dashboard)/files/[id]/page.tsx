    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card>
        ...
        <CardContent className="p-4 pt-0">
          ...
          {/* Amenities */}
          {(file.hasElevator || file.hasParking || file.hasStorage || file.hasBalcony || file.hasSecurity || file.hasGym || file.hasPool || file.hasWesternToilet || file.hasSmartHome || file.hasSauna || file.hasJacuzzi || file.hasRoofGarden) && (

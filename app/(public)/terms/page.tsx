...
export const metadata = { title: "شرایط استفاده — املاک‌بین" }

const sections = [
  {
    title: "پذیرش شرایط",
    body: `با ثبت‌نام و استفاده از خدمات املاک‌بین، شرایط زیر را می‌پذیرید. اگر با هر بخشی موافق نیستید، لطفاً از استفاده از سرویس خودداری کنید.`,
  },
  {
    title: "شرح خدمات",
    body: `املاک‌بین یک پلتفرم SaaS برای مدیریت دفاتر مشاور املاک است. ما امکان ثبت فایل، مدیریت مشتری، اشتراک‌گذاری لینک ملک، ثبت قرارداد، و گزارش‌گیری مالی را فراهم می‌کنیم. خدمات به‌صورت ابری و با اشتراک ماهانه یا سالانه ارائه می‌شود.`,
  },
  {
    title: "تعهدات کاربر",
